...
GM.Config.microwavefoodcost             = 60
...
GM.Config.CategoryOverride = {
    jobs = {
        ...
        ["Gangster"]                            = "Citoyens",
        ["Mob boss"]                            = "Citoyens",
        ["Civil Protection Chief"]              = "Protection civile",
        ["Mayor"]                               = "Protection civile",
    },
    entities = {
        ["Drug lab"]                            = "Other",
        ["Money printer"]                       = "Other",
...
GM.Config.DefaultLaws = {
    "Les printers sont illégaux",
    "Le vol est illégal!",
    "La drogue est illégale!",
}
...
GM.Config.hudText = "Je suis un tueur a gage!."
